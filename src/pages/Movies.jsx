      ...
      <div className="max-w-[1600px] mx-auto px-10 py-14">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Szukaj filmów..." value={search} onChange={e => { setSearch(e.target.value); setVisibleCount(VISIBLE_STEP); }}
        ...
        {moviesLoading ? (
          ...
          <>
            ...
            <div className="flex items-center justify-center gap-4 mt-10">
              {hasMore && (
                <button onClick={() => setVisibleCount(c => c + VISIBLE_STEP)} className="flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/8 text-white/70 hover:text-white px-6 py-2.5 rounded-xl text-sm font-medium transition-all">
                  Pokaż więcej
                </button>
              )}
            </div>
